...
('Ricavi',            'Totale ricavi conseguiti nel periodo',          'mario.rossi'),
('Costi operativi',   'Totale costi operativi sostenuti nel periodo',  'mario.rossi'),
('EBITDA',            'Utile prima di interessi, tasse e ammortamenti','mario.rossi'),
('Patrimonio netto',  'Differenza tra attivo e passivo patrimoniale',  'mario.rossi'),
('Debiti finanziari', 'Totale debiti finanziari a breve e lungo',      'mario.rossi');
...
('2022-04-15 10:00:00', 'Ricavi in linea con le aspettative di budget.',         'giulia.bianchi', 'Ricavi',          1, 'GreenTech SRL'),
('2022-04-15 10:05:00', 'Costi operativi leggermente elevati rispetto al piano.','giulia.bianchi', 'Costi operativi', 1, 'GreenTech SRL'),
('2023-05-10 09:00:00', 'Crescita ricavi confermata rispetto al 2022.',          'giulia.bianchi', 'Ricavi',          2, 'GreenTech SRL'),
('2023-06-01 11:00:00', 'EBITDA positivo, buon segnale per la gestione.',        'luca.verdi',     'EBITDA',          4, 'EcoFarm SPA'),
('2022-07-20 14:00:00', 'Costi troppo elevati rispetto ai ricavi dichiarati.',   'giulia.bianchi', 'Costi operativi', 6, 'BluEnergy SRL');
