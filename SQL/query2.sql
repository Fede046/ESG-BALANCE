...
-- FIX: valore ENUM corretto (minuscolo) + filtro su Ragione_sociale_bilancio per PK composta
...
-- FIX: valori ENUM corretti (minuscolo) + tutti i filtri usano anche Ragione_sociale per PK composta
